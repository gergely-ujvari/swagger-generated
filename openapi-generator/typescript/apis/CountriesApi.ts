...
export class CountriesApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async countriesGet(acceptLanguage?: string, _options?: Configuration): Promise<RequestContext> {
...
export class CountriesApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to countriesGet
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async countriesGet(response: ResponseContext): Promise<Array<Country> > {
