...
export class OddsService {
    ...
    public eventsIdLiveoddsGet(id: string, xOddClient: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<Odd>>(`${this.basePath}/events/${encodeURIComponent(String(id))}/liveodds`,
            {
    ...
    public eventsIdOddsGet(id: string, xOddClient: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<Odd>>(`${this.basePath}/events/${encodeURIComponent(String(id))}/odds`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public liveoddsGet(xOddClient: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<Odd>>(`${this.basePath}/liveodds`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public oddProvidersGet(xOddClient: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<OddProvider>>(`${this.basePath}/odd_providers`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public oddsGet(oddClient: string, fromEventStartTime?: Date, toEventStartTime?: Date, teamId?: number, teamIds?: string, eventOrder?: string, matchIds?: string, tournamentIds?: string, seasonIds?: string, oddsType?: 'prematch' | 'live' | 'all', observe?: 'body', reportProgress?: boolean): Observable<Array<Odd>>;
    public oddsGet(oddClient: string, fromEventStartTime?: Date, toEventStartTime?: Date, teamId?: number, teamIds?: string, eventOrder?: string, matchIds?: string, tournamentIds?: string, seasonIds?: string, oddsType?: 'prematch' | 'live' | 'all', observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Odd>>>;
    public oddsGet(oddClient: string, fromEventStartTime?: Date, toEventStartTime?: Date, teamId?: number, teamIds?: string, eventOrder?: string, matchIds?: string, tournamentIds?: string, seasonIds?: string, oddsType?: 'prematch' | 'live' | 'all', observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Odd>>>;
    public oddsGet(oddClient: string, fromEventStartTime?: Date, toEventStartTime?: Date, teamId?: number, teamIds?: string, eventOrder?: string, matchIds?: string, tournamentIds?: string, seasonIds?: string, oddsType?: 'prematch' | 'live' | 'all', observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<Odd>>(`${this.basePath}/odds`,
            {
    ...
    public pregameoddsGet(xOddClient: string, fromTime?: Date, toTime?: Date, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<Odd>>(`${this.basePath}/pregameodds`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
