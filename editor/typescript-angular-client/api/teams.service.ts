...
export class TeamsService {
     ...
     */
    public countriesIdTeamsGet(id: string, acceptLanguage?: string, national?: '1' | '0' | 'true' | 'false', observe?: 'body', reportProgress?: boolean): Observable<Array<Team>>;
    public countriesIdTeamsGet(id: string, acceptLanguage?: string, national?: '1' | '0' | 'true' | 'false', observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Team>>>;
    public countriesIdTeamsGet(id: string, acceptLanguage?: string, national?: '1' | '0' | 'true' | 'false', observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Team>>>;
    public countriesIdTeamsGet(id: string, acceptLanguage?: string, national?: '1' | '0' | 'true' | 'false', observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<Team>>(`${this.basePath}/countries/${encodeURIComponent(String(id))}/teams`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public teamsIdEventsGet(id: string, acceptLanguage?: string, fromTime?: Date, toTime?: Date, direction?: 'asc' | 'desc', tournamentSeasonStageId?: number, observe?: 'body', reportProgress?: boolean): Observable<Array<Event>>;
    public teamsIdEventsGet(id: string, acceptLanguage?: string, fromTime?: Date, toTime?: Date, direction?: 'asc' | 'desc', tournamentSeasonStageId?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Event>>>;
    public teamsIdEventsGet(id: string, acceptLanguage?: string, fromTime?: Date, toTime?: Date, direction?: 'asc' | 'desc', tournamentSeasonStageId?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Event>>>;
    public teamsIdEventsGet(id: string, acceptLanguage?: string, fromTime?: Date, toTime?: Date, direction?: 'asc' | 'desc', tournamentSeasonStageId?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<Event>>(`${this.basePath}/teams/${encodeURIComponent(String(id))}/events`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public teamsIdFormGet(id: string, acceptLanguage?: string, expand?: 'events', observe?: 'body', reportProgress?: boolean): Observable<Array<TeamForm>>;
    public teamsIdFormGet(id: string, acceptLanguage?: string, expand?: 'events', observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<TeamForm>>>;
    public teamsIdFormGet(id: string, acceptLanguage?: string, expand?: 'events', observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<TeamForm>>>;
    public teamsIdFormGet(id: string, acceptLanguage?: string, expand?: 'events', observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<TeamForm>>(`${this.basePath}/teams/${encodeURIComponent(String(id))}/form`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public teamsIdGet(id: string, acceptLanguage?: string, expand?: 'form' | 'form.events' | 'form.events,next_event', observe?: 'body', reportProgress?: boolean): Observable<Team>;
    public teamsIdGet(id: string, acceptLanguage?: string, expand?: 'form' | 'form.events' | 'form.events,next_event', observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Team>>;
    public teamsIdGet(id: string, acceptLanguage?: string, expand?: 'form' | 'form.events' | 'form.events,next_event', observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Team>>;
    public teamsIdGet(id: string, acceptLanguage?: string, expand?: 'form' | 'form.events' | 'form.events,next_event', observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public teamsIdPlayersGet(id: string, acceptLanguage?: string, groupBy?: 'position', observe?: 'body', reportProgress?: boolean): Observable<Array<TeamPlayer>>;
    public teamsIdPlayersGet(id: string, acceptLanguage?: string, groupBy?: 'position', observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<TeamPlayer>>>;
    public teamsIdPlayersGet(id: string, acceptLanguage?: string, groupBy?: 'position', observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<TeamPlayer>>>;
    public teamsIdPlayersGet(id: string, acceptLanguage?: string, groupBy?: 'position', observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<TeamPlayer>>(`${this.basePath}/teams/${encodeURIComponent(String(id))}/players`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public teamsIdPlayersStatisticsGet(id: string, acceptLanguage?: string, groupBy?: 'player.position', observe?: 'body', reportProgress?: boolean): Observable<TeamPlayerSeasonStatistics>;
    public teamsIdPlayersStatisticsGet(id: string, acceptLanguage?: string, groupBy?: 'player.position', observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<TeamPlayerSeasonStatistics>>;
    public teamsIdPlayersStatisticsGet(id: string, acceptLanguage?: string, groupBy?: 'player.position', observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<TeamPlayerSeasonStatistics>>;
    public teamsIdPlayersStatisticsGet(id: string, acceptLanguage?: string, groupBy?: 'player.position', observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<TeamPlayerSeasonStatistics>(`${this.basePath}/teams/${encodeURIComponent(String(id))}/players/statistics`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public teamsIdPlayersStatisticsSeasonsGet(id: string, acceptLanguage?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<TournamentSeasonWithTournament>>(`${this.basePath}/teams/${encodeURIComponent(String(id))}/players/statistics/seasons`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public teamsIdPlayersStatisticsSeasonsSeasonIdGet(seasonId: number, id: string, acceptLanguage?: string, groupBy?: 'player.position', observe?: 'body', reportProgress?: boolean): Observable<TeamPlayerSeasonStatistics>;
    public teamsIdPlayersStatisticsSeasonsSeasonIdGet(seasonId: number, id: string, acceptLanguage?: string, groupBy?: 'player.position', observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<TeamPlayerSeasonStatistics>>;
    public teamsIdPlayersStatisticsSeasonsSeasonIdGet(seasonId: number, id: string, acceptLanguage?: string, groupBy?: 'player.position', observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<TeamPlayerSeasonStatistics>>;
    public teamsIdPlayersStatisticsSeasonsSeasonIdGet(seasonId: number, id: string, acceptLanguage?: string, groupBy?: 'player.position', observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<TeamPlayerSeasonStatistics>(`${this.basePath}/teams/${encodeURIComponent(String(id))}/players/statistics/seasons/${encodeURIComponent(String(seasonId))}`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public teamsIdStatisticsLeagueGet(id: string, acceptLanguage?: string, standing?: 'team' | 'full', observe?: 'body', reportProgress?: boolean): Observable<TeamSeasonStatistics>;
    public teamsIdStatisticsLeagueGet(id: string, acceptLanguage?: string, standing?: 'team' | 'full', observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<TeamSeasonStatistics>>;
    public teamsIdStatisticsLeagueGet(id: string, acceptLanguage?: string, standing?: 'team' | 'full', observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<TeamSeasonStatistics>>;
    public teamsIdStatisticsLeagueGet(id: string, acceptLanguage?: string, standing?: 'team' | 'full', observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<TeamSeasonStatistics>(`${this.basePath}/teams/${encodeURIComponent(String(id))}/statistics/league`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public v2TeamsColorsPost(teamColorsDto?: V2TeamColors, observe?: 'body', reportProgress?: boolean): Observable<V2TeamColors>;
    public v2TeamsColorsPost(teamColorsDto?: V2TeamColors, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<V2TeamColors>>;
    public v2TeamsColorsPost(teamColorsDto?: V2TeamColors, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<V2TeamColors>>;
    public v2TeamsColorsPost(teamColorsDto?: V2TeamColors, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post<V2TeamColors>(`${this.basePath}/v2/teams/colors`,
            teamColorsDto,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public v2TeamsGet(offset: number, limit: number, languageCode?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<TeamPageDto>(`${this.basePath}/v2/teams`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public v2TeamsIdGet(id: string, languageCode?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<V2TeamProfile>(`${this.basePath}/v2/teams/${encodeURIComponent(String(id))}`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public v2TeamsIdPut(team: TeamEditDto, id: string, observe?: 'body', reportProgress?: boolean): Observable<V2TeamProfile>;
    public v2TeamsIdPut(team: TeamEditDto, id: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<V2TeamProfile>>;
    public v2TeamsIdPut(team: TeamEditDto, id: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<V2TeamProfile>>;
    public v2TeamsIdPut(team: TeamEditDto, id: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.put<V2TeamProfile>(`${this.basePath}/v2/teams/${encodeURIComponent(String(id))}`,
            team,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public v2TeamsPost(teamEditDto?: TeamEditDto, observe?: 'body', reportProgress?: boolean): Observable<V2TeamProfile>;
    public v2TeamsPost(teamEditDto?: TeamEditDto, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<V2TeamProfile>>;
    public v2TeamsPost(teamEditDto?: TeamEditDto, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<V2TeamProfile>>;
    public v2TeamsPost(teamEditDto?: TeamEditDto, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post<V2TeamProfile>(`${this.basePath}/v2/teams`,
            teamEditDto,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
