...
export class EventPlayerTypeApi {
     ...
     */
    public eventPlayerTypesGet(acceptLanguage?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.EventPlayerType;  }> {
        let localVarPath = this.basePath + '/event_player_types';
        ...
        $.ajax(requestOptions).then(
            (data: models.EventPlayerType, textStatus: string, jqXHR: JQueryXHR) =>
