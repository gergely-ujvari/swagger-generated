...
export class RoundsApi {
     ...
     */
    public v2RoundsGet(seasonId: number, languageCode?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.V2RoundTypes;  }> {
        let localVarPath = this.basePath + '/v2/rounds';
        ...
        $.ajax(requestOptions).then(
            (data: models.V2RoundTypes, textStatus: string, jqXHR: JQueryXHR) =>
     ...
     * @param languageCode Returns translated response based on the language code
     */
    public v2StagesIdRoundsGet(id: string, languageCode?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.V2RoundTypes;  }> {
        let localVarPath = this.basePath + '/v2/stages/{id}/rounds'.replace('{' + 'id' + '}', encodeURIComponent(String(id)));
