...
export class CountriesApi {
     ...
     */
    public countriesGet(acceptLanguage?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: Array<models.Country>;  }> {
        let localVarPath = this.basePath + '/countries';
        ...
        $.ajax(requestOptions).then(
            (data: Array<models.Country>, textStatus: string, jqXHR: JQueryXHR) =>
