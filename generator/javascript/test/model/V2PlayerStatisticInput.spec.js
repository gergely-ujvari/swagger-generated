...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V2PlayerStatisticInput', function() {
      beforeEach(function() {
        instance = new FootballApi.V2PlayerStatisticInput();
      });

      it('should create an instance of V2PlayerStatisticInput', function() {
        // TODO: update the code to test V2PlayerStatisticInput
        expect(instance).to.be.a(FootballApi.V2PlayerStatisticInput);
      });
