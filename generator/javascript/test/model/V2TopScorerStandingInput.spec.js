...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V2TopScorerStandingInput', function() {
      beforeEach(function() {
        instance = new FootballApi.V2TopScorerStandingInput();
      });

      it('should create an instance of V2TopScorerStandingInput', function() {
        // TODO: update the code to test V2TopScorerStandingInput
        expect(instance).to.be.a(FootballApi.V2TopScorerStandingInput);
      });
