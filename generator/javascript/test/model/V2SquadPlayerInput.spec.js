...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V2SquadPlayerInput', function() {
      beforeEach(function() {
        instance = new FootballApi.V2SquadPlayerInput();
      });

      it('should create an instance of V2SquadPlayerInput', function() {
        // TODO: update the code to test V2SquadPlayerInput
        expect(instance).to.be.a(FootballApi.V2SquadPlayerInput);
      });
