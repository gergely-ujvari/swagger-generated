...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CityEditDto', function() {
      beforeEach(function() {
        instance = new FootballApi.CityEditDto();
      });

      it('should create an instance of CityEditDto', function() {
        // TODO: update the code to test CityEditDto
        expect(instance).to.be.a(FootballApi.CityEditDto);
      });
