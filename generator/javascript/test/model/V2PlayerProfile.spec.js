...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V2PlayerProfile', function() {
      beforeEach(function() {
        instance = new FootballApi.V2PlayerProfile();
      });

      it('should create an instance of V2PlayerProfile', function() {
        // TODO: update the code to test V2PlayerProfile
        expect(instance).to.be.a(FootballApi.V2PlayerProfile);
      });
