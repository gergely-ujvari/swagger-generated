...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V2Asset', function() {
      beforeEach(function() {
        instance = new FootballApi.V2Asset();
      });

      it('should create an instance of V2Asset', function() {
        // TODO: update the code to test V2Asset
        expect(instance).to.be.a(FootballApi.V2Asset);
      });
