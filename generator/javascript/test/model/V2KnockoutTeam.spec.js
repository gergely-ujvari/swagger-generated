...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V2KnockoutTeam', function() {
      beforeEach(function() {
        instance = new FootballApi.V2KnockoutTeam();
      });

      it('should create an instance of V2KnockoutTeam', function() {
        // TODO: update the code to test V2KnockoutTeam
        expect(instance).to.be.a(FootballApi.V2KnockoutTeam);
      });
