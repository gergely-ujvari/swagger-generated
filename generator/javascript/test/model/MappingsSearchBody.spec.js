...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MappingsSearchBody', function() {
      beforeEach(function() {
        instance = new FootballApi.MappingsSearchBody();
      });

      it('should create an instance of MappingsSearchBody', function() {
        // TODO: update the code to test MappingsSearchBody
        expect(instance).to.be.a(FootballApi.MappingsSearchBody);
      });
