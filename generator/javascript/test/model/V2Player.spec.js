...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V2Player', function() {
      beforeEach(function() {
        instance = new FootballApi.V2Player();
      });

      it('should create an instance of V2Player', function() {
        // TODO: update the code to test V2Player
        expect(instance).to.be.a(FootballApi.V2Player);
      });
