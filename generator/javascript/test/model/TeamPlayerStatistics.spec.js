...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TeamPlayerStatistics', function() {
      beforeEach(function() {
        instance = new FootballApi.TeamPlayerStatistics();
      });

      it('should create an instance of TeamPlayerStatistics', function() {
        // TODO: update the code to test TeamPlayerStatistics
        expect(instance).to.be.a(FootballApi.TeamPlayerStatistics);
      });
