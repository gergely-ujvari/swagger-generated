...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PlayerPageDto', function() {
      beforeEach(function() {
        instance = new FootballApi.PlayerPageDto();
      });

      it('should create an instance of PlayerPageDto', function() {
        // TODO: update the code to test PlayerPageDto
        expect(instance).to.be.a(FootballApi.PlayerPageDto);
      });
