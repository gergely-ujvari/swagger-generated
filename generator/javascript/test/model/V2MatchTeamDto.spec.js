...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V2MatchTeamDto', function() {
      beforeEach(function() {
        instance = new FootballApi.V2MatchTeamDto();
      });

      it('should create an instance of V2MatchTeamDto', function() {
        // TODO: update the code to test V2MatchTeamDto
        expect(instance).to.be.a(FootballApi.V2MatchTeamDto);
      });
      ...
      it('should have the property shirtColor (base name: "$shirt_color")', function() {
        // TODO: update the code to test the property shirtColor
        expect(instance).to.have.property('shirtColor');
        // expect(instance.shirtColor).to.be(expectedValueLiteral);
      });
