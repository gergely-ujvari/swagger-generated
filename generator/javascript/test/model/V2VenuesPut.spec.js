...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V2VenuesPut', function() {
      beforeEach(function() {
        instance = new FootballApi.V2VenuesPut();
      });

      it('should create an instance of V2VenuesPut', function() {
        // TODO: update the code to test V2VenuesPut
        expect(instance).to.be.a(FootballApi.V2VenuesPut);
      });
