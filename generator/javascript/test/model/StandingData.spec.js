...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StandingData', function() {
      beforeEach(function() {
        instance = new FootballApi.StandingData();
      });

      it('should create an instance of StandingData', function() {
        // TODO: update the code to test StandingData
        expect(instance).to.be.a(FootballApi.StandingData);
      });
