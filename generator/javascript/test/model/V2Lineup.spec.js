...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V2Lineup', function() {
      beforeEach(function() {
        instance = new FootballApi.V2Lineup();
      });

      it('should create an instance of V2Lineup', function() {
        // TODO: update the code to test V2Lineup
        expect(instance).to.be.a(FootballApi.V2Lineup);
      });
