...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListVenueDto', function() {
      beforeEach(function() {
        instance = new FootballApi.ListVenueDto();
      });

      it('should create an instance of ListVenueDto', function() {
        // TODO: update the code to test ListVenueDto
        expect(instance).to.be.a(FootballApi.ListVenueDto);
      });
