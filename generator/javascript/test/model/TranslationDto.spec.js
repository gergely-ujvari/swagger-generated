...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TranslationDto', function() {
      beforeEach(function() {
        instance = new FootballApi.TranslationDto();
      });

      it('should create an instance of TranslationDto', function() {
        // TODO: update the code to test TranslationDto
        expect(instance).to.be.a(FootballApi.TranslationDto);
      });
