...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RefereePageDto', function() {
      beforeEach(function() {
        instance = new FootballApi.RefereePageDto();
      });

      it('should create an instance of RefereePageDto', function() {
        // TODO: update the code to test RefereePageDto
        expect(instance).to.be.a(FootballApi.RefereePageDto);
      });
