...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V2MappingRequestDto', function() {
      beforeEach(function() {
        instance = new FootballApi.V2MappingRequestDto();
      });

      it('should create an instance of V2MappingRequestDto', function() {
        // TODO: update the code to test V2MappingRequestDto
        expect(instance).to.be.a(FootballApi.V2MappingRequestDto);
      });
