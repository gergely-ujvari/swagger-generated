...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V2TeamScore', function() {
      beforeEach(function() {
        instance = new FootballApi.V2TeamScore();
      });

      it('should create an instance of V2TeamScore', function() {
        // TODO: update the code to test V2TeamScore
        expect(instance).to.be.a(FootballApi.V2TeamScore);
      });
