...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BlacklistKeyDto', function() {
      beforeEach(function() {
        instance = new FootballApi.BlacklistKeyDto();
      });

      it('should create an instance of BlacklistKeyDto', function() {
        // TODO: update the code to test BlacklistKeyDto
        expect(instance).to.be.a(FootballApi.BlacklistKeyDto);
      });
