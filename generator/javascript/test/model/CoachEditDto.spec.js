...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CoachEditDto', function() {
      beforeEach(function() {
        instance = new FootballApi.CoachEditDto();
      });

      it('should create an instance of CoachEditDto', function() {
        // TODO: update the code to test CoachEditDto
        expect(instance).to.be.a(FootballApi.CoachEditDto);
      });
