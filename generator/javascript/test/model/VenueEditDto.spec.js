...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VenueEditDto', function() {
      beforeEach(function() {
        instance = new FootballApi.VenueEditDto();
      });

      it('should create an instance of VenueEditDto', function() {
        // TODO: update the code to test VenueEditDto
        expect(instance).to.be.a(FootballApi.VenueEditDto);
      });
