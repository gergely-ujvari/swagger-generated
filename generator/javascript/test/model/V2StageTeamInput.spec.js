...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V2StageTeamInput', function() {
      beforeEach(function() {
        instance = new FootballApi.V2StageTeamInput();
      });

      it('should create an instance of V2StageTeamInput', function() {
        // TODO: update the code to test V2StageTeamInput
        expect(instance).to.be.a(FootballApi.V2StageTeamInput);
      });
