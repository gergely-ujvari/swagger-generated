...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V2VenuesGetId', function() {
      beforeEach(function() {
        instance = new FootballApi.V2VenuesGetId();
      });

      it('should create an instance of V2VenuesGetId', function() {
        // TODO: update the code to test V2VenuesGetId
        expect(instance).to.be.a(FootballApi.V2VenuesGetId);
      });
