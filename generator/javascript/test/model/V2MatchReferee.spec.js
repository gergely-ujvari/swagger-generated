...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V2MatchReferee', function() {
      beforeEach(function() {
        instance = new FootballApi.V2MatchReferee();
      });

      it('should create an instance of V2MatchReferee', function() {
        // TODO: update the code to test V2MatchReferee
        expect(instance).to.be.a(FootballApi.V2MatchReferee);
      });
