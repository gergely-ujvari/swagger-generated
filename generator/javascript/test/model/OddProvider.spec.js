...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OddProvider', function() {
      beforeEach(function() {
        instance = new FootballApi.OddProvider();
      });

      it('should create an instance of OddProvider', function() {
        // TODO: update the code to test OddProvider
        expect(instance).to.be.a(FootballApi.OddProvider);
      });
