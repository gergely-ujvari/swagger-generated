...
export class TournamentsService {
     ...
     */
    public tournamentsGet(acceptLanguage?: string, countryId?: number, clientOrder?: string, expandClientSortorder?: string, observe?: 'body', reportProgress?: boolean): Observable<Array<Tournament>>;
    public tournamentsGet(acceptLanguage?: string, countryId?: number, clientOrder?: string, expandClientSortorder?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Tournament>>>;
    public tournamentsGet(acceptLanguage?: string, countryId?: number, clientOrder?: string, expandClientSortorder?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Tournament>>>;
    public tournamentsGet(acceptLanguage?: string, countryId?: number, clientOrder?: string, expandClientSortorder?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<Tournament>>('get',`${this.basePath}/tournaments`,
            {
    ...
    public tournamentsIdGet(id: string, acceptLanguage?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<TournamentWithSeasons>('get',`${this.basePath}/tournaments/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public tournamentsIdSeasonsGet(id: string, acceptLanguage?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<TournamentSeason>>('get',`${this.basePath}/tournaments/${encodeURIComponent(String(id))}/seasons`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public tournamentsIdSeasonsLatestGet(id: number, acceptLanguage?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<TournamentSeasonWithStages>('get',`${this.basePath}/tournaments/${encodeURIComponent(String(id))}/seasons/latest`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public tournamentsSeasonsIdCardlistGet(id: number, acceptLanguage?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<CardlistStandingData>>('get',`${this.basePath}/tournaments/seasons/${encodeURIComponent(String(id))}/cardlist`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public tournamentsSeasonsIdEventsGet(id: number, acceptLanguage?: string, groupBy?: string, observe?: 'body', reportProgress?: boolean): Observable<Array<Event>>;
    public tournamentsSeasonsIdEventsGet(id: number, acceptLanguage?: string, groupBy?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Event>>>;
    public tournamentsSeasonsIdEventsGet(id: number, acceptLanguage?: string, groupBy?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Event>>>;
    public tournamentsSeasonsIdEventsGet(id: number, acceptLanguage?: string, groupBy?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<Event>>('get',`${this.basePath}/tournaments/seasons/${encodeURIComponent(String(id))}/events`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public tournamentsSeasonsIdGet(id: number, acceptLanguage?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<TournamentSeasonWithStages>('get',`${this.basePath}/tournaments/seasons/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public tournamentsSeasonsIdTopscorerGet(id: number, acceptLanguage?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<TopscorerStandingData>>('get',`${this.basePath}/tournaments/seasons/${encodeURIComponent(String(id))}/topscorer`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public tournamentsSeasonsStagesActiveGet(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<TournamentSeasonStage>>('get',`${this.basePath}/tournaments/seasons/stages/active`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public tournamentsSeasonsStagesGroupsIdGet(id: number, expand?: string, acceptLanguage?: string, observe?: 'body', reportProgress?: boolean): Observable<StageGroupWithStandingTournamentSeasonStage>;
    public tournamentsSeasonsStagesGroupsIdGet(id: number, expand?: string, acceptLanguage?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<StageGroupWithStandingTournamentSeasonStage>>;
    public tournamentsSeasonsStagesGroupsIdGet(id: number, expand?: string, acceptLanguage?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<StageGroupWithStandingTournamentSeasonStage>>;
    public tournamentsSeasonsStagesGroupsIdGet(id: number, expand?: string, acceptLanguage?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<StageGroupWithStandingTournamentSeasonStage>('get',`${this.basePath}/tournaments/seasons/stages/groups/${encodeURIComponent(String(id))}`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public tournamentsSeasonsStagesGroupsIdStandingGet(id: number, expand?: string, acceptLanguage?: string, observe?: 'body', reportProgress?: boolean): Observable<Array<LeagueStandingData>>;
    public tournamentsSeasonsStagesGroupsIdStandingGet(id: number, expand?: string, acceptLanguage?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<LeagueStandingData>>>;
    public tournamentsSeasonsStagesGroupsIdStandingGet(id: number, expand?: string, acceptLanguage?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<LeagueStandingData>>>;
    public tournamentsSeasonsStagesGroupsIdStandingGet(id: number, expand?: string, acceptLanguage?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<LeagueStandingData>>('get',`${this.basePath}/tournaments/seasons/stages/groups/${encodeURIComponent(String(id))}/standing`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public tournamentsSeasonsStagesIdGet(id: number, expand?: string, acceptLanguage?: string, observe?: 'body', reportProgress?: boolean): Observable<TournamentSeasonStageWithStandingGroups>;
    public tournamentsSeasonsStagesIdGet(id: number, expand?: string, acceptLanguage?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<TournamentSeasonStageWithStandingGroups>>;
    public tournamentsSeasonsStagesIdGet(id: number, expand?: string, acceptLanguage?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<TournamentSeasonStageWithStandingGroups>>;
    public tournamentsSeasonsStagesIdGet(id: number, expand?: string, acceptLanguage?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<TournamentSeasonStageWithStandingGroups>('get',`${this.basePath}/tournaments/seasons/stages/${encodeURIComponent(String(id))}`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public tournamentsSeasonsStagesIdRoundsGet(id: number, expand?: string, observe?: 'body', reportProgress?: boolean): Observable<Array<Round>>;
    public tournamentsSeasonsStagesIdRoundsGet(id: number, expand?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Round>>>;
    public tournamentsSeasonsStagesIdRoundsGet(id: number, expand?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Round>>>;
    public tournamentsSeasonsStagesIdRoundsGet(id: number, expand?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<Round>>('get',`${this.basePath}/tournaments/seasons/stages/${encodeURIComponent(String(id))}/rounds`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public tournamentsSeasonsStagesIdStandingGet(id: number, expand?: string, acceptLanguage?: string, observe?: 'body', reportProgress?: boolean): Observable<Array<LeagueStandingData>>;
    public tournamentsSeasonsStagesIdStandingGet(id: number, expand?: string, acceptLanguage?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<LeagueStandingData>>>;
    public tournamentsSeasonsStagesIdStandingGet(id: number, expand?: string, acceptLanguage?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<LeagueStandingData>>>;
    public tournamentsSeasonsStagesIdStandingGet(id: number, expand?: string, acceptLanguage?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<LeagueStandingData>>('get',`${this.basePath}/tournaments/seasons/stages/${encodeURIComponent(String(id))}/standing`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
