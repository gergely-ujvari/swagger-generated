...
export class MatchesService {
    ...
    public matchesIdCommentaryGet(id: string, languageCode: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<LiveCommentaryOutputDto>>('get',`${this.basePath}/matches/${encodeURIComponent(String(id))}/commentary`,
            {
    ...
    public v2MatchesGet(limit: number, offset: number, tournamentIds?: Array<number>, seasonIds?: Array<number>, stageIds?: Array<number>, groupIds?: Array<number>, roundIds?: Array<string>, roundFilter?: Array<string>, fromKickoffTime?: Date, toKickoffTime?: Date, teamIds?: Array<number>, statusTypes?: Array<string>, statusCodes?: Array<string>, refereeId?: number, venueId?: string, sortDirection?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        let queryParameters = new HttpParams({encoder: new CustomHttpUrlEncodingCodec()});
        if (tournamentIds) {
            queryParameters = queryParameters.set('tournament_ids', tournamentIds.join(COLLECTION_FORMATS['csv']));
        }
        if (seasonIds) {
            queryParameters = queryParameters.set('season_ids', seasonIds.join(COLLECTION_FORMATS['csv']));
        }
        if (stageIds) {
            queryParameters = queryParameters.set('stage_ids', stageIds.join(COLLECTION_FORMATS['csv']));
        }
        if (groupIds) {
            queryParameters = queryParameters.set('group_ids', groupIds.join(COLLECTION_FORMATS['csv']));
        }
        if (roundIds) {
            queryParameters = queryParameters.set('round_ids', roundIds.join(COLLECTION_FORMATS['csv']));
        }
        if (roundFilter) {
            queryParameters = queryParameters.set('round_filter', roundFilter.join(COLLECTION_FORMATS['csv']));
        }
        ...
        if (teamIds) {
            queryParameters = queryParameters.set('team_ids', teamIds.join(COLLECTION_FORMATS['csv']));
        }
        if (statusTypes) {
            queryParameters = queryParameters.set('status_types', statusTypes.join(COLLECTION_FORMATS['csv']));
        }
        if (statusCodes) {
            queryParameters = queryParameters.set('status_codes', statusCodes.join(COLLECTION_FORMATS['csv']));
        }
        ...
        return this.httpClient.request<Array<V2Match>>('get',`${this.basePath}/v2/matches`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public v2MatchesIdGet(id: string, languageCode?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<V2Match>('get',`${this.basePath}/v2/matches/${encodeURIComponent(String(id))}`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * 
     * 
     * @param body Match information to save
     * @param id Unique identifier of the resource.
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public v2MatchesIdPut(body: V2MatchInput, id: string, observe?: 'body', reportProgress?: boolean): Observable<V2Match>;
    public v2MatchesIdPut(body: V2MatchInput, id: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<V2Match>>;
    public v2MatchesIdPut(body: V2MatchInput, id: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<V2Match>>;
    public v2MatchesIdPut(body: V2MatchInput, id: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling v2MatchesIdPut.');
        }
        ...
        return this.httpClient.request<V2Match>('put',`${this.basePath}/v2/matches/${encodeURIComponent(String(id))}`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public v2MatchesLivescoreGet(matchIds?: Array<number>, date?: string, utcOffset?: number, tournamentGroup?: string, statusTypes?: Array<string>, selectionFilter?: string, observe?: 'body', reportProgress?: boolean): Observable<Array<V2Match>>;
    public v2MatchesLivescoreGet(matchIds?: Array<number>, date?: string, utcOffset?: number, tournamentGroup?: string, statusTypes?: Array<string>, selectionFilter?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<V2Match>>>;
    public v2MatchesLivescoreGet(matchIds?: Array<number>, date?: string, utcOffset?: number, tournamentGroup?: string, statusTypes?: Array<string>, selectionFilter?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<V2Match>>>;
    public v2MatchesLivescoreGet(matchIds?: Array<number>, date?: string, utcOffset?: number, tournamentGroup?: string, statusTypes?: Array<string>, selectionFilter?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        let queryParameters = new HttpParams({encoder: new CustomHttpUrlEncodingCodec()});
        if (matchIds) {
            queryParameters = queryParameters.set('match_ids', matchIds.join(COLLECTION_FORMATS['csv']));
        }
        ...
        return this.httpClient.request<Array<V2Match>>('get',`${this.basePath}/v2/matches/livescore`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public v2MatchesPost(body: V2MatchInput, observe?: 'body', reportProgress?: boolean): Observable<V2Match>;
    public v2MatchesPost(body: V2MatchInput, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<V2Match>>;
    public v2MatchesPost(body: V2MatchInput, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<V2Match>>;
    public v2MatchesPost(body: V2MatchInput, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling v2MatchesPost.');
        }
        ...
        return this.httpClient.request<V2Match>('post',`${this.basePath}/v2/matches`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
