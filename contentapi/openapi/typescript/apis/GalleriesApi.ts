...
export class GalleriesApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param sort Sort
     */
    public async galleriesGet(page?: number, limit?: number, sort?: string, _options?: Configuration): Promise<RequestContext> {
     ...
     * @param id 
     */
    public async galleriesIdDelete(id: number, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new RequiredError("GalleriesApi", "galleriesIdDelete", "id");
        }
     ...
     * @param id 
     */
    public async galleriesIdGet(id: number, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new RequiredError("GalleriesApi", "galleriesIdGet", "id");
        }
     ...
     */
    public async galleriesIdPatch(id: number, galleryUpdateRequest?: GalleryUpdateRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new RequiredError("GalleriesApi", "galleriesIdPatch", "id");
        }
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(galleryUpdateRequest, "GalleryUpdateRequest", ""),
            contentType
        );
     ...
     * @param id 
     */
    public async galleriesIdRelatedGet(id: number, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new RequiredError("GalleriesApi", "galleriesIdRelatedGet", "id");
        }


        // Path Params
        const localVarPath = '/galleries/{id}/related'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
     ...
     */
    public async galleriesIdRelatedPost(id: number, relatedResponseInner?: Array<RelatedResponseInner>, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new RequiredError("GalleriesApi", "galleriesIdRelatedPost", "id");
        }
     ...
     */
    public async galleriesPost(galleryRequest?: GalleryRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        requestContext.setHeaderParam("Content-Type", contentType);
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(galleryRequest, "GalleryRequest", ""),
            contentType
        );
        requestContext.setBody(serializedBody);
    ...
    public async galleriesSearchGet(query: string, ids?: string, category?: number, createdBy?: number, originId?: number, status?: string, type?: string, publishedChannels?: string, publishedRegions?: string, teamIds?: string, playerIds?: string, tagIds?: string, matchId?: number, tournamentId?: number, tournamentIds?: string, championshipId?: number, roundId?: number, language?: string, categoryTreeId?: number, authorIds?: string, limit?: number, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/galleries/search';
...
export class GalleriesApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to galleriesGet
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async galleriesGet(response: ResponseContext): Promise<GalleriesCollection > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: GalleriesCollection = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "GalleriesCollection", ""
            ) as GalleriesCollection;
            return body;
        }
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to galleriesIdDelete
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async galleriesIdDelete(response: ResponseContext): Promise<void > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            return;
        }
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to galleriesIdGet
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async galleriesIdGet(response: ResponseContext): Promise<GalleriesIdDelete200Response > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: GalleriesIdDelete200Response = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "GalleriesIdDelete200Response", ""
            ) as GalleriesIdDelete200Response;
            return body;
        }
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to galleriesIdPatch
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async galleriesIdPatch(response: ResponseContext): Promise<GalleriesIdDelete200Response > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: GalleriesIdDelete200Response = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to galleriesIdRelatedGet
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async galleriesIdRelatedGet(response: ResponseContext): Promise<Array<RelatedResponseInner> > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to galleriesIdRelatedPost
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async galleriesIdRelatedPost(response: ResponseContext): Promise<Array<RelatedResponseInner> > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: Array<RelatedResponseInner> = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to galleriesPost
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async galleriesPost(response: ResponseContext): Promise<GalleryResponse > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: GalleryResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "GalleryResponse", ""
            ) as GalleryResponse;
            return body;
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to galleriesSearchGet
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async galleriesSearchGet(response: ResponseContext): Promise<GalleriesCollection > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: GalleriesCollection = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
