...
export class TournamentGroupsService {
    ...
    public v2TournamentsGroupsCodeGet(code: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<V2TournamentGroupGetOutput>(`${this.basePath}/v2/tournaments/groups/${encodeURIComponent(String(code))}`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public v2TournamentsGroupsCodePut(code: string, group: V2TournamentGroupUpdateInput, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public v2TournamentsGroupsCodePut(code: string, group: V2TournamentGroupUpdateInput, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public v2TournamentsGroupsCodePut(code: string, group: V2TournamentGroupUpdateInput, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public v2TournamentsGroupsCodePut(code: string, group: V2TournamentGroupUpdateInput, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.put<any>(`${this.basePath}/v2/tournaments/groups/${encodeURIComponent(String(code))}`,
            group,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public v2TournamentsGroupsCodeSelectionDatePost(code: string, date: string, matchIds?: Array<V2TournamentGroupSelection>, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public v2TournamentsGroupsCodeSelectionDatePost(code: string, date: string, matchIds?: Array<V2TournamentGroupSelection>, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public v2TournamentsGroupsCodeSelectionDatePost(code: string, date: string, matchIds?: Array<V2TournamentGroupSelection>, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public v2TournamentsGroupsCodeSelectionDatePost(code: string, date: string, matchIds?: Array<V2TournamentGroupSelection>, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post<any>(`${this.basePath}/v2/tournaments/groups/${encodeURIComponent(String(code))}/selection/${encodeURIComponent(String(date))}`,
            matchIds,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public v2TournamentsGroupsGet(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<V2TournamentGroupCollection>(`${this.basePath}/v2/tournaments/groups`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public v2TournamentsGroupsPost(group: V2TournamentGroupInsertInput, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public v2TournamentsGroupsPost(group: V2TournamentGroupInsertInput, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public v2TournamentsGroupsPost(group: V2TournamentGroupInsertInput, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public v2TournamentsGroupsPost(group: V2TournamentGroupInsertInput, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post<any>(`${this.basePath}/v2/tournaments/groups`,
            group,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
