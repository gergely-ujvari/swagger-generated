...
export class EventsService {
    ...
    public eventsByTeamsGet(homeId: number, awayId: number, acceptLanguage?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Event>(`${this.basePath}/events/by_teams`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public eventsGet(acceptLanguage?: string, fromTime?: Date, toTime?: Date, groupBy?: '' | 'tournament_season_stage', clientOrder?: 'sportalios', observe?: 'body', reportProgress?: boolean): Observable<Array<Event>>;
    public eventsGet(acceptLanguage?: string, fromTime?: Date, toTime?: Date, groupBy?: '' | 'tournament_season_stage', clientOrder?: 'sportalios', observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Event>>>;
    public eventsGet(acceptLanguage?: string, fromTime?: Date, toTime?: Date, groupBy?: '' | 'tournament_season_stage', clientOrder?: 'sportalios', observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Event>>>;
    public eventsGet(acceptLanguage?: string, fromTime?: Date, toTime?: Date, groupBy?: '' | 'tournament_season_stage', clientOrder?: 'sportalios', observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<Event>>(`${this.basePath}/events`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public eventsIdGet(id: string, acceptLanguage?: string, expand?: 'form' | 'form.events', observe?: 'body', reportProgress?: boolean): Observable<Event>;
    public eventsIdGet(id: string, acceptLanguage?: string, expand?: 'form' | 'form.events', observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Event>>;
    public eventsIdGet(id: string, acceptLanguage?: string, expand?: 'form' | 'form.events', observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Event>>;
    public eventsIdGet(id: string, acceptLanguage?: string, expand?: 'form' | 'form.events', observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public eventsIdIncidentsGet(id: string, acceptLanguage?: string, groupBy?: 'team', direction?: 'asc' | 'desc', observe?: 'body', reportProgress?: boolean): Observable<Array<EventIncident>>;
    public eventsIdIncidentsGet(id: string, acceptLanguage?: string, groupBy?: 'team', direction?: 'asc' | 'desc', observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<EventIncident>>>;
    public eventsIdIncidentsGet(id: string, acceptLanguage?: string, groupBy?: 'team', direction?: 'asc' | 'desc', observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<EventIncident>>>;
    public eventsIdIncidentsGet(id: string, acceptLanguage?: string, groupBy?: 'team', direction?: 'asc' | 'desc', observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<EventIncident>>(`${this.basePath}/events/${encodeURIComponent(String(id))}/incidents`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public eventsIdLineupsGet(id: number, acceptLanguage?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Lineup>(`${this.basePath}/events/${encodeURIComponent(String(id))}/lineups`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public eventsIdPlayersGet(id: string, acceptLanguage?: string, groupBy?: 'team', observe?: 'body', reportProgress?: boolean): Observable<Array<EventPlayer>>;
    public eventsIdPlayersGet(id: string, acceptLanguage?: string, groupBy?: 'team', observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<EventPlayer>>>;
    public eventsIdPlayersGet(id: string, acceptLanguage?: string, groupBy?: 'team', observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<EventPlayer>>>;
    public eventsIdPlayersGet(id: string, acceptLanguage?: string, groupBy?: 'team', observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<EventPlayer>>(`${this.basePath}/events/${encodeURIComponent(String(id))}/players`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public eventsIdPregameoddsGet(id: string, xOddClient: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<Odd>>(`${this.basePath}/events/${encodeURIComponent(String(id))}/pregameodds`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public eventsLiveGet(acceptLanguage?: string, groupBy?: 'tournament_season_stage', observe?: 'body', reportProgress?: boolean): Observable<Array<Event>>;
    public eventsLiveGet(acceptLanguage?: string, groupBy?: 'tournament_season_stage', observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Event>>>;
    public eventsLiveGet(acceptLanguage?: string, groupBy?: 'tournament_season_stage', observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Event>>>;
    public eventsLiveGet(acceptLanguage?: string, groupBy?: 'tournament_season_stage', observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<Event>>(`${this.basePath}/events/live`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public eventsSinceGet(acceptLanguage?: string, lastUpdate?: Date, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<Event>>(`${this.basePath}/events/since`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public matchesGet(acceptLanguage?: string, fromStartTime?: Date, toStartTime?: Date, teamIds?: string, matchIds?: string, tournamentIds?: string, stageIds?: string, rounds?: string, seasonIds?: string, statusTypes?: 'finished' | 'notstarted' | 'inprogress' | 'interrupted' | 'cancelled', offset?: number, limit?: number, tournamentOrder?: string, refereeId?: string, venueId?: string, statusCode?: string, sortDirection?: 'asc' | 'desc', observe?: 'body', reportProgress?: boolean): Observable<Array<Event>>;
    public matchesGet(acceptLanguage?: string, fromStartTime?: Date, toStartTime?: Date, teamIds?: string, matchIds?: string, tournamentIds?: string, stageIds?: string, rounds?: string, seasonIds?: string, statusTypes?: 'finished' | 'notstarted' | 'inprogress' | 'interrupted' | 'cancelled', offset?: number, limit?: number, tournamentOrder?: string, refereeId?: string, venueId?: string, statusCode?: string, sortDirection?: 'asc' | 'desc', observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Event>>>;
    public matchesGet(acceptLanguage?: string, fromStartTime?: Date, toStartTime?: Date, teamIds?: string, matchIds?: string, tournamentIds?: string, stageIds?: string, rounds?: string, seasonIds?: string, statusTypes?: 'finished' | 'notstarted' | 'inprogress' | 'interrupted' | 'cancelled', offset?: number, limit?: number, tournamentOrder?: string, refereeId?: string, venueId?: string, statusCode?: string, sortDirection?: 'asc' | 'desc', observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Event>>>;
    public matchesGet(acceptLanguage?: string, fromStartTime?: Date, toStartTime?: Date, teamIds?: string, matchIds?: string, tournamentIds?: string, stageIds?: string, rounds?: string, seasonIds?: string, statusTypes?: 'finished' | 'notstarted' | 'inprogress' | 'interrupted' | 'cancelled', offset?: number, limit?: number, tournamentOrder?: string, refereeId?: string, venueId?: string, statusCode?: string, sortDirection?: 'asc' | 'desc', observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<Event>>(`${this.basePath}/matches`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
