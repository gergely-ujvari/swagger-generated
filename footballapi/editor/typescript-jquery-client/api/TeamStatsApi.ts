...
export class TeamStatsApi {
     ...
     */
    public eventTeamstatsGet(acceptLanguage?: string, lastUpdate?: Date, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: Array<models.EventTeamStats>;  }> {
        let localVarPath = this.basePath + '/event_teamstats';
        ...
        $.ajax(requestOptions).then(
            (data: Array<models.EventTeamStats>, textStatus: string, jqXHR: JQueryXHR) =>
     ...
     * @param acceptLanguage List of acceptable human languages for response. https://en.wikipedia.org/wiki/Content_negotiation
     */
    public eventsIdTeamstatsGet(id: number, acceptLanguage?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: Array<models.EventTeamStats>;  }> {
        let localVarPath = this.basePath + '/events/{id}/teamstats'.replace('{' + 'id' + '}', encodeURIComponent(String(id)));
