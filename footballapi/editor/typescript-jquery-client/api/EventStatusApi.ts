...
export class EventStatusApi {
     ...
     */
    public eventStatusGet(acceptLanguage?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQueryPromise<{ response: JQueryXHR; body: models.EventStatus;  }> {
        let localVarPath = this.basePath + '/event_status';
        ...
        $.ajax(requestOptions).then(
            (data: models.EventStatus, textStatus: string, jqXHR: JQueryXHR) =>
