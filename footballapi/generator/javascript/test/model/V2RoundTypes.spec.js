...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V2RoundTypes', function() {
      beforeEach(function() {
        instance = new FootballApi.V2RoundTypes();
      });

      it('should create an instance of V2RoundTypes', function() {
        // TODO: update the code to test V2RoundTypes
        expect(instance).to.be.a(FootballApi.V2RoundTypes);
      });
