...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RefereeDto', function() {
      beforeEach(function() {
        instance = new FootballApi.RefereeDto();
      });

      it('should create an instance of RefereeDto', function() {
        // TODO: update the code to test RefereeDto
        expect(instance).to.be.a(FootballApi.RefereeDto);
      });
