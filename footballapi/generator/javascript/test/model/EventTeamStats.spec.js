...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EventTeamStats', function() {
      beforeEach(function() {
        instance = new FootballApi.EventTeamStats();
      });

      it('should create an instance of EventTeamStats', function() {
        // TODO: update the code to test EventTeamStats
        expect(instance).to.be.a(FootballApi.EventTeamStats);
      });
