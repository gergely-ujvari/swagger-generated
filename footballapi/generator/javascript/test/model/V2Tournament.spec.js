...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V2Tournament', function() {
      beforeEach(function() {
        instance = new FootballApi.V2Tournament();
      });

      it('should create an instance of V2Tournament', function() {
        // TODO: update the code to test V2Tournament
        expect(instance).to.be.a(FootballApi.V2Tournament);
      });
