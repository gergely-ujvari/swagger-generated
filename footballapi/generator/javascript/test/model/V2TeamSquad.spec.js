...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V2TeamSquad', function() {
      beforeEach(function() {
        instance = new FootballApi.V2TeamSquad();
      });

      it('should create an instance of V2TeamSquad', function() {
        // TODO: update the code to test V2TeamSquad
        expect(instance).to.be.a(FootballApi.V2TeamSquad);
      });
