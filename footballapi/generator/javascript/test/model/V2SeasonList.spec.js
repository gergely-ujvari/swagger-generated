...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V2SeasonList', function() {
      beforeEach(function() {
        instance = new FootballApi.V2SeasonList();
      });

      it('should create an instance of V2SeasonList', function() {
        // TODO: update the code to test V2SeasonList
        expect(instance).to.be.a(FootballApi.V2SeasonList);
      });
