...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TournamentWithSeasons', function() {
      beforeEach(function() {
        instance = new FootballApi.TournamentWithSeasons();
      });

      it('should create an instance of TournamentWithSeasons', function() {
        // TODO: update the code to test TournamentWithSeasons
        expect(instance).to.be.a(FootballApi.TournamentWithSeasons);
      });
