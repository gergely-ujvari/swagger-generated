...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TournamentDto', function() {
      beforeEach(function() {
        instance = new FootballApi.TournamentDto();
      });

      it('should create an instance of TournamentDto', function() {
        // TODO: update the code to test TournamentDto
        expect(instance).to.be.a(FootballApi.TournamentDto);
      });
