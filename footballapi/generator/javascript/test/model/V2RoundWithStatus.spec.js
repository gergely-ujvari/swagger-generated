...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V2RoundWithStatus', function() {
      beforeEach(function() {
        instance = new FootballApi.V2RoundWithStatus();
      });

      it('should create an instance of V2RoundWithStatus', function() {
        // TODO: update the code to test V2RoundWithStatus
        expect(instance).to.be.a(FootballApi.V2RoundWithStatus);
      });
