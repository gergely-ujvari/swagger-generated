...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V2Team', function() {
      beforeEach(function() {
        instance = new FootballApi.V2Team();
      });

      it('should create an instance of V2Team', function() {
        // TODO: update the code to test V2Team
        expect(instance).to.be.a(FootballApi.V2Team);
      });
