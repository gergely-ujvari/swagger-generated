...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VenueDto', function() {
      beforeEach(function() {
        instance = new FootballApi.VenueDto();
      });

      it('should create an instance of VenueDto', function() {
        // TODO: update the code to test VenueDto
        expect(instance).to.be.a(FootballApi.VenueDto);
      });
