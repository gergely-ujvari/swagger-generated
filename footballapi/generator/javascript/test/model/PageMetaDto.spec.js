...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PageMetaDto', function() {
      beforeEach(function() {
        instance = new FootballApi.PageMetaDto();
      });

      it('should create an instance of PageMetaDto', function() {
        // TODO: update the code to test PageMetaDto
        expect(instance).to.be.a(FootballApi.PageMetaDto);
      });
