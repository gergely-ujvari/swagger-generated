...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V2PlayerStatisticOutput', function() {
      beforeEach(function() {
        instance = new FootballApi.V2PlayerStatisticOutput();
      });

      it('should create an instance of V2PlayerStatisticOutput', function() {
        // TODO: update the code to test V2PlayerStatisticOutput
        expect(instance).to.be.a(FootballApi.V2PlayerStatisticOutput);
      });
