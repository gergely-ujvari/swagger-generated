...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V2MatchStage', function() {
      beforeEach(function() {
        instance = new FootballApi.V2MatchStage();
      });

      it('should create an instance of V2MatchStage', function() {
        // TODO: update the code to test V2MatchStage
        expect(instance).to.be.a(FootballApi.V2MatchStage);
      });
