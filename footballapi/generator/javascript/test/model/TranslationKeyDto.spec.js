...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TranslationKeyDto', function() {
      beforeEach(function() {
        instance = new FootballApi.TranslationKeyDto();
      });

      it('should create an instance of TranslationKeyDto', function() {
        // TODO: update the code to test TranslationKeyDto
        expect(instance).to.be.a(FootballApi.TranslationKeyDto);
      });
