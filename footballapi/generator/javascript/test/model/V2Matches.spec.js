...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V2Matches', function() {
      beforeEach(function() {
        instance = new FootballApi.V2Matches();
      });

      it('should create an instance of V2Matches', function() {
        // TODO: update the code to test V2Matches
        expect(instance).to.be.a(FootballApi.V2Matches);
      });
