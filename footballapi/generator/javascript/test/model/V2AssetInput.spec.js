...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V2AssetInput', function() {
      beforeEach(function() {
        instance = new FootballApi.V2AssetInput();
      });

      it('should create an instance of V2AssetInput', function() {
        // TODO: update the code to test V2AssetInput
        expect(instance).to.be.a(FootballApi.V2AssetInput);
      });
