...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TranslationEntityDto', function() {
      beforeEach(function() {
        instance = new FootballApi.TranslationEntityDto();
      });

      it('should create an instance of TranslationEntityDto', function() {
        // TODO: update the code to test TranslationEntityDto
        expect(instance).to.be.a(FootballApi.TranslationEntityDto);
      });
