...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V2MatchStatus', function() {
      beforeEach(function() {
        instance = new FootballApi.V2MatchStatus();
      });

      it('should create an instance of V2MatchStatus', function() {
        // TODO: update the code to test V2MatchStatus
        expect(instance).to.be.a(FootballApi.V2MatchStatus);
      });
