...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StageGroupWithStanding', function() {
      beforeEach(function() {
        instance = new FootballApi.StageGroupWithStanding();
      });

      it('should create an instance of StageGroupWithStanding', function() {
        // TODO: update the code to test StageGroupWithStanding
        expect(instance).to.be.a(FootballApi.StageGroupWithStanding);
      });
