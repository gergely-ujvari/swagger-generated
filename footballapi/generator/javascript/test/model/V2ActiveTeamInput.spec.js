...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V2ActiveTeamInput', function() {
      beforeEach(function() {
        instance = new FootballApi.V2ActiveTeamInput();
      });

      it('should create an instance of V2ActiveTeamInput', function() {
        // TODO: update the code to test V2ActiveTeamInput
        expect(instance).to.be.a(FootballApi.V2ActiveTeamInput);
      });
