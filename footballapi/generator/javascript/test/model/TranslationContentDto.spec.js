...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TranslationContentDto', function() {
      beforeEach(function() {
        instance = new FootballApi.TranslationContentDto();
      });

      it('should create an instance of TranslationContentDto', function() {
        // TODO: update the code to test TranslationContentDto
        expect(instance).to.be.a(FootballApi.TranslationContentDto);
      });
