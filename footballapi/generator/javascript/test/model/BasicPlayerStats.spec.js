...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BasicPlayerStats', function() {
      beforeEach(function() {
        instance = new FootballApi.BasicPlayerStats();
      });

      it('should create an instance of BasicPlayerStats', function() {
        // TODO: update the code to test BasicPlayerStats
        expect(instance).to.be.a(FootballApi.BasicPlayerStats);
      });
