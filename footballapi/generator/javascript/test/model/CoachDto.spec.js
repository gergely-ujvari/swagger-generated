...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CoachDto', function() {
      beforeEach(function() {
        instance = new FootballApi.CoachDto();
      });

      it('should create an instance of CoachDto', function() {
        // TODO: update the code to test CoachDto
        expect(instance).to.be.a(FootballApi.CoachDto);
      });
